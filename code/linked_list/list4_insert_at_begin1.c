// Linked list : insert_at_begin() implementation : returning new 'head'
#include <stdio.h>
#include <stdlib.h>
...
node_t *insert_at_begin(node_t *head, int value)
{
  ...
  // Ques: will above code work in case of empty linked list too?
...
int main()
{
  ...
  head = insert_at_begin(head, 10); // insertion into empty list
  head = insert_at_begin(head, 20); // insertion into non-empty list
